...
async def lifespan(app: FastAPI):
    ...
    try:
        # 加载航次合规状态审批API，统一挂载到 /external 前缀下
            ...
            try:
                ...
                if first_result:
                    ...
                    his_record = {
                        ...
                        "user_id": user_id if user_id else "system",  # 默认值
                        "user_name": user_name if user_name else "system",  # 默认值
                        "depart_id": depart_id if depart_id else "system",  # 默认值
                        "depart_name": depart_name if depart_name else "system",  # 默认值
                        "is_delete": "0",
